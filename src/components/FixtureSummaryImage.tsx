...
export const FixtureSummaryImage = forwardRef<HTMLDivElement, FixtureSummaryImageProps>(
  ({ tournament, selectedRound = "ALL" }, ref) => {
    // Filter matches
    ...
    return (
      ...
      >
        {/* Decoración de fondo */}
        <div className="absolute top-0 left-0 w-full h-1/3 bg-gradient-to-b from-blue-900/40 to-transparent z-0"></div>
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-600/30 via-blue-800/10 to-transparent rounded-full z-0"></div>
        <div className="absolute -bottom-40 -left-40 w-[600px] h-[600px] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-green-600/20 via-green-800/5 to-transparent rounded-full z-0"></div>
