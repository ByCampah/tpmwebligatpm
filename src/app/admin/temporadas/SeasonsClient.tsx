...
export default function SeasonsClient({ seasons, categories, userRole, isAdmin }: { seasons: any[], categories: any[], userRole: string, isAdmin?: boolean }) {
                ...
                <h3 className="font-black text-xl flex items-center gap-2">
                  ...
                  {userRole === "ADMIN" && (
                    <div className="flex gap-2">
                      ...
                      {isAdmin && (
                        <button 
                          className="bg-red-500/10 text-red-500 p-2 rounded-lg hover:bg-red-500 hover:text-white transition-all disabled:opacity-50"
                          disabled={loading}
                ...
                {season.tournaments.map((t: any) => (
                  <div key={t.id} className="bg-secondary/30 p-3 rounded flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                      ...
                      {isAdmin && (
                        <button 
                          className="bg-red-500/10 text-red-500 p-2 rounded hover:bg-red-500 hover:text-white transition-all disabled:opacity-50 mt-1 md:mt-0"
                          disabled={loading}
