    ...
    <div className="flex flex-col gap-12 max-w-5xl mx-auto">
      ...
      <section className="text-center py-16 px-4 bg-card rounded-2xl border border-border shadow-lg relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="https://dl.dropboxusercontent.com/s/rud9i5kqrabsajy/TPM.rar?dl=0" target="_blank" rel="noreferrer" className="px-8 py-4 bg-primary text-primary-foreground font-bold rounded-full hover:bg-primary/90 transition-transform hover:scale-105 active:scale-95 shadow-[0_0_15px_rgba(16,185,129,0.5)] flex items-center justify-center gap-2 text-lg w-full sm:w-auto">
            ⬇ DESCARGAR JUEGO
          </a>
          <a href="https://discord.gg/xpGVgQ4qSN" target="_blank" rel="noreferrer" className="px-8 py-4 bg-[#5865F2] text-white font-bold rounded-full hover:bg-[#4752C4] transition-transform hover:scale-105 active:scale-95 shadow-[0_0_15px_rgba(88,101,242,0.5)] flex items-center justify-center gap-2 text-lg w-full sm:w-auto">
